...
Widget _buildLegsWorkoutContent() {
  ...
  TextEditingController lyingLegCurlWeightController = TextEditingController();
  ...
  TextEditingController legExtensionWeightController = TextEditingController();
...
Widget _buildPushDayWorkoutContent() {
  ...
  TextEditingController tricepExtensionSetsController = TextEditingController();
  TextEditingController tricepExtensionRepsController = TextEditingController();
  TextEditingController tricepExtensionWeightController = TextEditingController();
  ...
  TextEditingController shoulderShrugWeightController = TextEditingController();
  ...
  TextEditingController lateralRaiseWeightController = TextEditingController();
  bool isLateralRaiseCompleted = false;

  TextEditingController inclineBenchPressSetsController = TextEditingController();
  TextEditingController inclineBenchPressRepsController = TextEditingController();
  TextEditingController inclineBenchPressWeightController = TextEditingController();
  bool isInclineBenchPressCompleted = false;

  TextEditingController inclineChestFlySetsController = TextEditingController();
  TextEditingController inclineChestFlyRepsController = TextEditingController();
  TextEditingController inclineChestFlyWeightController = TextEditingController();
...
Widget _buildPullDayWorkoutContent() {
  TextEditingController bicepCurlDumbbellSetsController = TextEditingController();
  TextEditingController bicepCurlDumbbellRepsController = TextEditingController();
  TextEditingController bicepCurlDumbbellWeightController = TextEditingController();
  bool isBicepCurlDumbbellCompleted = false;

  TextEditingController hammerCurlDumbbellSetsController = TextEditingController();
  TextEditingController hammerCurlDumbbellRepsController = TextEditingController();
  TextEditingController hammerCurlDumbbellWeightController = TextEditingController();
  bool isHammerCurlDumbbellCompleted = false;

  TextEditingController bicepCurlBarbellSetsController = TextEditingController();
  TextEditingController bicepCurlBarbellRepsController = TextEditingController();
  TextEditingController bicepCurlBarbellWeightController = TextEditingController();
...
Widget _buildAbsDayWorkoutContent() {
  TextEditingController bicycleCrunchesSetsController = TextEditingController();
  TextEditingController bicycleCrunchesRepsController = TextEditingController();
  TextEditingController bicycleCrunchesWeightController = TextEditingController();
  ...
  TextEditingController russianTwistsWeightController = TextEditingController();
...
Widget _buildExerciseTile(
  ...
  void suggestedSave(String exerciseName, String weight, String reps, String sets) {
  Exercise newExercise = Exercise(name: exerciseName, weight: weight, reps: reps, sets: sets);
  // Add exercise to the database based on workout name and the new exercise
  WorkoutHistoryDB().addExercise(widget.workoutName, newExercise);
  Navigator.pop(context);
  clear();
